class SketchModel {
  ...
  SketchModel(this.url);
}

class UsersData {
  static final List users = [
    SketchModel('assets/art/2.png'),
    SketchModel('assets/art/3.png'),
    SketchModel('assets/art/4.png'),
    SketchModel('assets/art/5.png'),
    SketchModel('assets/art/6.png'),
